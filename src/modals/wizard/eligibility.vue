      ...
      <div class="flex justify-center">
        <div class="">
          <div class="space-y-10">
            ...
            <div class="bg-[#F8F8F8] py-16">
              <div class="flex justify-center">
                <div class="space-y-3">
                  ...
                  <label for="file" class="flex justify-center cursor-pointer">
                    <img
                      src="/images/png/picture.png"
                      class="w-4 h-3"
                      alt="upload"
                    />
                  </label>
                  ...
                  <p
                    class="text-[#4E4E4E]text-center font-extrabold text-[11px]"
                  >
                    UPLOAD IMAGE OF PVC
                  </p>
                </div>
            ...
            <div class="text-[#4E4E4E] space-y-12">
              <div class="flex space-x-3 font-extrabold text-[11px]">
                <p class="">Do you own a smart phone?</p>
              ...
              <div class="flex w-full space-x-3 font-extrabold text-[11px]">
                <p class="">
                  Are you able to browse,<br />connect to WhatsApp or<br />
                  Telegram in your Polling Unit
                </p>
                <div class="flex space-x-3">
                  <p>YES</p>
                  <label class="container" for="yes2">
                    <input type="checkbox" class="mr-3" name="yes" id="yes2" />
                    <span class="checkmark"></span>
                  </label>
                </div>
              ...
              <div class="flex w-auto space-x-3 font-extrabold text-[11px]">
                <p class="">
                  What party does Peter Obi<br />
                  belong to?
                </p>
                <div class="flex space-x-3 w-1/2 flex-wrap">
                  <div class="flex space-x-3">
                    <p>APC</p>
